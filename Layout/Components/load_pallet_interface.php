            ...
            <form class="form-horizontal" action="" method="POST" autocomplete="off" style="width:100%;">
            	<div class="form-control">
            	    ...
            	    <div style="">
                		...
                		<p class="small float-right"> <a href="<?php $_SERVER['PHP_SELF']; ?>?remove_loading_pullback_number">Change pullback</a></p>
            		...
            		<div style="margin-top: 10px;">
            		    <input class="form-control btn btn-primary" type="submit" name="load_pallet" value="Load pallet" style="height:55px; width:50%;  float: right;"/>
            		</div>
